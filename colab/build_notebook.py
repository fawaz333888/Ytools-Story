...
CELLS: list[dict] = [
    ...
    },
    {
        ...
        "source": [
            ...
            "spectrum_style = 'cqt' #@param ['cqt','spectrum','waves','vectorscope']  # cqt = bar graf, paling cocok untuk bicara\n",
            "spectrum_position = 'bottom' #@param ['bottom','center']  # bottom bisa nabrak subtitle: naikkan margin_v atau pakai center\n",
            "spectrum_height = 0 #@param {type:'integer'}  # 0 = auto (20% tinggi video)\n",
            ...
            "card_title = '' #@param {type:'string'}  # kosong + provider LLM = judul dari LLM; manual wajib isi\n",
            "\n",
            "#@markdown --- **Output** ---\n",
